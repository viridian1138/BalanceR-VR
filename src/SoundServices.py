...
#        self.strtSources[ 0 ] = openal.oalOpen("BalanceRClip.wav")
#        self.strtSources[ 1 ] = openal.oalOpen("BalanceRClip2.wav")
        for cnt in range( len( self.strtSources ) ) :
            self.strtSources[ cnt ] = pygame.mixer.Sound("BalanceRClip.wav")
