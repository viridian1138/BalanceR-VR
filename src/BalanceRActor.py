...
class BalanceRActor(object):
    ...
    def init_gl(self):
        ...
        scene.strategiesDumbbell = [ None ] * 1;

        scene.strategiesDumbbell[0] = scene.dumbbellStrategy;
        ...
        scene.strategiesLeft = [ None ] * 2;

        scene.strategiesLeft[0] = scene.leftFrontKickAbdomenStrategy;

        scene.strategiesLeft[1] = scene.leftFrontKickLegStrategy;
        ...
        scene.strategiesRight = [ None ] * 2;

        scene.strategiesRight[0] = scene.rightFrontKickAbdomenStrategy;

        scene.strategiesRight[1] = scene.rightFrontKickLegStrategy;
            ...
            if now > self.scene.endTime :
                ...
                if not ( self.scene.nextSequence == None ) :
                    ...
                    if True :
                        ...
                        randLeft = random.randrange( 10 )
                        
                        if randLeft < 1 : 
                            self.scene.onLeft = not ( self.scene.onLeft )
                            
                        dumbbellRand = random.randrange( 10 )
                        
                        if dumbbellRand < 1 :
                            
                            randn = random.randrange( len( self.scene.strategiesDumbbell ) )

                            self.scene.strategiesDumbbell[randn].init(self.scene, self.scene.endTime);
                            
                        else:
                            
                            if self.scene.onLeft :
                        
                                randn = random.randrange( len( self.scene.strategiesLeft ) )

                                self.scene.strategiesLeft[randn].init(self.scene, self.scene.endTime);
                                
                            else:
                        
                                randn = random.randrange( len( self.scene.strategiesRight ) )

                                self.scene.strategiesRight[randn].init(self.scene, self.scene.endTime);
